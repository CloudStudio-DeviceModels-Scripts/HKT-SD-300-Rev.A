...
# Parsing + Configuration Script – HKT-SD-300 - Rev. A

This **Parsing + Configuration** script is designed for the **HKT-SD-300** model in **Gear Studio**, part of the [Cloud Studio](https://www.cloud.studio/) platform.
...
# Script de Parsing + Configuration – HKT-SD-300 Rev. A

Este script de **Parsing + Configuration** está diseñado para el modelo **HKT-SD-300** en **Gear Studio**, parte de la plataforma [Cloud Studio](https://www.cloud.studio/).
