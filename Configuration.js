...
function getEndpoints(deviceAddress, endpoints) {
    ...
    endpoints.addEndpoint("2", "Smoke Alarm", endpointType.iasSensor, iasEndpointSubType.alarmInput);
    endpoints.addEndpoint("3", "Temperature Alarm", endpointType.iasSensor, iasEndpointSubType.alarmInput);
    endpoints.addEndpoint("4", "Battery", endpointType.voltageSensor);
